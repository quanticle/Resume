...
{\small Github: http://github.com/quanticle}\\
{\small Stack Overflow: http://stackoverflow.com/users/149125/quanticle}
\section*{Professional Experience}
\noindent Software Developer at {\bfseries Intradyn Inc.}\dotfill May 2011 to present\\
Eagan, MN
\begin{resume-list}
\item Built federated search infrastructure using Erlang, Clojure and Python on Linux
...
\section*{Skills}
\begin{resume-list}
\item Works on personal open source projects (http://github.com/quanticle)
\item Is self taught in all major web programming languages, include Perl, Python, Ruby, PHP, and Javascript.
