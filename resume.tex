...
\end{resume-list}
\noindent Independent Software Consultant for {\bfseries HelloMakana.com}\dotfill April 2013 to August 2013\\
Seattle, WA
\begin{resume-list}
...
\item Gained experience working with a geographically distributed team
\end{resume-list}
