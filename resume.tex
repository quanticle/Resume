...
\noindent Independent Software Contractor\dotfill February 2022 to present\\
Plymouth, MN
\begin{resume-list}
\item Implemented e-commerce features for local small businesses
\item Created custom photo gallery software for Wordpress
\item Gained experience with Wordpress, PHP, and Vue.js to enable attractive product pages and photo galleries
\end{resume-list}
\noindent Senior Software Engineer at {\bfseries Nextera Analytics}\dotfill January 2021 to February 2022\\
St. Paul, MN
\begin{resume-list}
